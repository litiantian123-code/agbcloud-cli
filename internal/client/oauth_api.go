...
type OAuthAPI interface {
	...
	GetLoginProviderURLWithPort(ctx context.Context, fromUrlPath, loginClient, oauthProvider, localhostPort string) (OAuthLoginProviderResponse, *http.Response, error)
	...
	LoginTranslateWithPort(ctx context.Context, loginClient, oauthProvider, authCode, localhostPort string) (OAuthLoginTranslateResponse, *http.Response, error)
...
type OAuthLoginProviderData struct {
	...
	AlternativePorts string `json:"alternativePorts"`
}
...
// GetLoginProviderURLWithPort retrieves the OAuth login provider URL with localhostPort parameter
func (o *OAuthAPIService) GetLoginProviderURLWithPort(ctx context.Context, fromUrlPath, loginClient, oauthProvider, localhostPort string) (OAuthLoginProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue OAuthLoginProviderResponse
	...
	// Use the configured server URL (defaults to agb.cloud)
	serverURL, err := o.client.cfg.ServerURLWithContext(ctx, "GetLoginProviderURLWithPort")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// Add localhostPort parameter if provided
	if localhostPort != "" {
		localVarQueryParams.Add("localhostPort", localhostPort)
	}
...
// LoginTranslateWithPort translates OAuth authorization code to access token with localhostPort parameter
func (o *OAuthAPIService) LoginTranslateWithPort(ctx context.Context, loginClient, oauthProvider, authCode, localhostPort string) (OAuthLoginTranslateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue OAuthLoginTranslateResponse
	...
	// Use the configured server URL (defaults to agb.cloud)
	serverURL, err := o.client.cfg.ServerURLWithContext(ctx, "LoginTranslateWithPort")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
